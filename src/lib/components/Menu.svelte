...
<section
  ...
  class="relative z-10 bg-gradient-to-b from-black via-black/80 to-black pt-32 pb-12 backdrop-blur-3xl lg:pt-0 lg:pb-32 scroll-mt-24"
>
  <div class="mx-auto max-w-5xl px-0 lg:px-12 xl:px-6 xl:pb-96 2xl:px-0">
    <h2 class="serif text-4xl px-6 font-thin text-white xl:text-6xl">Menu</h2>
            ...
            {#each categories as c}
              <li>
                ...
                >
                  ...
                  <svg
                    class="h-4 w-4 transition-opacity {active === c.id ? 'opacity-100' : 'opacity-0'}"
        ...
        <div class="mt-4 space-y-6 px-4">
          ...
          {#each filtered as it (it.id)}
            ...
            >
              ...
              <button
                type="button"
                class="absolute right-4 bottom-4 inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/40 backdrop-blur hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-emerald-500/60"
